...
class ShareCatalogTest {
    ...
    fun shareCatalogTest() {
        ...
        // Tap the Share icon (TopAppBar)
        composeRule.onNodeWithContentDescription("Share catalog").performClick()

        // Verify the share dialog opened
        // The dialog usually shows the catalog name or an "Invite" button/text
