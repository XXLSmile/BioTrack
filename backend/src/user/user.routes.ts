...
router.post('/update-fcm-token', userController.updateFcmToken.bind(userController));
router.delete('/fcm-token', userController.clearFcmToken.bind(userController));
